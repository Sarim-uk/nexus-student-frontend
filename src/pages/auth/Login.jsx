              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  <motion.button
                    ...
                    whileTap={{ scale: 0.97 }}
                    className={`relative w-full flex justify-center items-center py-3 px-4 ${
                      loading ? "bg-gray-400" : "bg-gradient-to-r from-primary to-accent"
                    } text-white rounded-md shadow-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent transition-transform duration-200`}
                    disabled={loading}
                  >
                    {loading ? (
              ...
              <div className="mt-6">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white text-gray-500">New to Nexus Academy?</span>
                  </div>
                </div>
                
                <div className="mt-4">
                  {/* Using the new RegisterButton component */}
                  {/* This is a fallback in case the component doesn't load */}
                  {(() => {
                    try {
                      const RegisterButton = require('../../components/auth/RegisterButton').default;
                      return <RegisterButton fullWidth label="Create a new account" />;
                    } catch (e) {
                      // Fallback to simple button if component can't be loaded
                      return (
                        <motion.div
                          whileHover={{ scale: 1.03 }}
                          whileTap={{ scale: 0.97 }}
